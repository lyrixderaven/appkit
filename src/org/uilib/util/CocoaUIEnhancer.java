...
public class CocoaUIEnhancer {
	 ...
	 *            <tt>null</tt> here.
	 */
	public CocoaUIEnhancer(final String appName) {
	 ...
	 */
	public void hookApplicationMenu(final Display display, final Listener quitListener, final Runnable aboutAction,
	...
	private Object invoke(final Class<?> cls, final String methodName, final Class<?> paramTypes[], Object... arguments) {
		try {
	...
	private Object invoke(final Object obj, final String methodName, final Class<?> paramTypes[], Object... arguments) {
		try {
	...
	private static class MenuHookObject {
		...
		public MenuHookObject(final Runnable about, final Runnable pref) {
			this.about     = about;
			this.pref	   = pref;
		}
